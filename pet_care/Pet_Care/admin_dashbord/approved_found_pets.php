...
<head>
    ...
    <title>Approved Found Pets</title>
...
<body>
    ...
    // Fetch all details from the approved_foundpet table
    $sql_approved_pets = "SELECT id, pet_type, pet_breed, found_location, found_date, pet_color, phone_number, pet_photo, user_email FROM approved_foundpet";
    $result_approved_pets = mysqli_query($conn, $sql_approved_pets);

    echo "<h2>Approved Found Pets</h2>";
    if (mysqli_num_rows($result_approved_pets) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result_approved_pets)) {
            echo "<tr>";
            echo "<td>";
            ...
            echo "<td>";
            echo "<a href='delete_approved_found_pet.php?id=" . $row['id'] . "' class='btn-delete' onclick='return confirm(\"Are you sure you want to delete this record?\");'>Delete</a>";
            echo "</td>";
        ...
        echo "No approved found pets found.";
    }
